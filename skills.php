...
<head>
    ...
    <title>My Skills - Dwiyan Toro</title>
...
<body class="bg-white dark:bg-gray-900 shadow transition-colors duration-300 transition-theme">
    ...
    <main class="container mx-auto py-16 px-6">
        <section id="skills" class="mt-16 fade-in">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-8 text-center italic">Skills</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 hover:scale-110 transition-all duration-500">
                    <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2 italic">HTML, CSS, & JavaScript</h3>
                    <p class="text-gray-600 dark:text-gray-300 italic">Intermediate knowledge of HTML, CSS (including frameworks like Tailwind and Bootstrap), and JavaScript (Vanilla JavaScript).</p>
                </div>
                <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 hover:scale-110 transition-all duration-500">
                    <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2 italic">PHP</h3>
                    <p class="text-gray-600 dark:text-gray-300 italic">Proficient in PHP, with experience in the Laravel framework (still in the learning process).</p>
                </div>
                <div
                    class="bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-4 hover:scale-110 transition-all duration-500">
                    <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-2 italic">Backend Development</h3>
                    <p class="text-gray-600 dark:text-gray-300 italic">Experienced in backend development using PHP and databases, such as MySQL and SQLite.</p>
                </div>
            </div>
        </section>
    </main>
