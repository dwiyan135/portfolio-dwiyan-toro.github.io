...
<head>
    ...
    <title>About Me - Dwiyan Toro</title>
...
<body class="bg-white dark:bg-gray-900 shadow transition-colors duration-300 transition-theme">
    ...
    <main class="container mx-auto py-16 px-6">
        <section id="about" class="text-center fade-in">
            <h1
                class="text-5xl md:text-7xl font-extrabold text-gray-800 dark:text-white mb-6 py-6 animate-fadeIn italic">
                About Me</h1>
            <p class="text-xl md:text-3xl text-gray-600 dark:text-gray-300 mb-12 leading-relaxed animate-fadeIn italic">
                I am Dwiyan Toro, a vocational school student majoring in Sistem, Informasi, Jaringan and Aplikasi (SIJA) and a passionate developer who loves creating modern and interactive web experiences.</p>
            <div class="flex flex-col md:flex-row items-center justify-center animate-fadeIn">
                <img src="img/Myself-3.jpg" alt="Dwiyan Toro"
                    class="w-72 h-72 rounded-full mb-10 md:mb-0 md:mr-12 shadow-lg transform hover:scale-105 transition-transform duration-300">
                <div class="text-left md:w-2/3">
                    <p class="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-6 leading-relaxed italic">Hello!
                        I'm Dwiyan Toro,  a student majoring in Sistem, Informasi, Jaringan, and Aplikasi (SIJA) and a dedicated and detail-oriented web developer with a knack for creating elegant
                        and user-friendly web solutions. With a strong foundation in modern web technologies, I strive
                        to deliver high-quality work that meets client expectations and drives results.</p>
                    <p class="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-6 leading-relaxed italic">Over the
                        years, I have honed my skills in HTML, CSS, JavaScript, and various frameworks and libraries. My
                        goal is to continuously learn and grow in the field, staying up-to-date with the latest trends
                        and best practices.</p>
                    <p class="text-lg md:text-xl text-gray-600 dark:text-gray-300 leading-relaxed italic">In my spare
                        time, I enjoy exploring new technologies, working on personal projects, and contributing to
                        open-source communities. I'm always eager to take on new challenges and collaborate with
