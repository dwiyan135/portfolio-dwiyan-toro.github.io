...
<head>
    ...
    <title>My Portfolio - Dwiyan Toro</title>
...
<body class="bg-gray-100 dark:bg-gray-900 shadow transition-colors duration-300 transition-theme">
    ...
    <main class="container mx-auto py-16 px-6">
        <section id="home" class="text-center fade-in">
            <img src="img/Myself-3.jpg" alt="Dwiyan Toro"
                class="w-32 h-32 rounded-full mx-auto mb-4 animate__animated animate__bounce hover:scale-110 transition-all duration-500">
            <h1 class="text-4xl md:text-6xl font-bold text-gray-800 dark:text-white mb-4 italic">Welcome to My Portfolio
            </h1>
            <p class="text-lg md:text-2xl text-gray-600 dark:text-gray-300 mb-8 italic">I am Dwiyan Toro, a vocational school student majoring in Sistem, Informasi, Jaringan and Aplikasi (SIJA) and a passionate developer who loves creating modern and interactive web experiences.</p>
            <a href="#projects"
                class="inline-block bg-indigo-600 text-white px-6 py-3 rounded-md text-lg font-medium hover:bg-indigo-700 dark:hover:bg-indigo-500 transition-transform transform hover:scale-105 italic">View
                My Work</a>
        </section>
